...
module.exports = function(registry) {
  ...
  PersistedModel.setupRemoting = function() {
    ...
    var upsertOptions = {
      ...
      description: g.f('Patch an existing model instance or insert a new one into the data source.'),
      accessType: 'WRITE',
    ...
    var updateAttributesOptions = {
      ...
      description: g.f('Patch attributes for a model instance and persist it into the data source.'),
      accessType: 'WRITE',
